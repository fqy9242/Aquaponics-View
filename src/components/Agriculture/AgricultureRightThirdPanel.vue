<script setup>
const graphData = [
    { range: 1, name: '大白菜', imagePath: '/assets/static/chinese-cabbage.jpg', value: '556亩' },
    { range: 2, name: '黄瓜', imagePath: '/assets/static/cucumber.png', value: '260亩' },
    { range: 3, name: '胡萝卜', imagePath: '/assets/static/carrot.png', value: '160亩' },
    { range: 4, name: '西红柿', imagePath: '/assets/static/tomato.jpg', value: '90亩' },
    { range: 5, name: '菠菜', imagePath: '/assets/static/spinach.jpg', value: '46亩' }
]
</script>
    ...
    <div class="panel-box water-quality-panel">
        ...
        <ul class="crop-list">
            ...
            <li class="crop-item">
                ...
                <img src="@/assets/static/carrot.png" draggable="false" class="crop-image" />
                <span class="crop-name">胡萝卜</span>
                <span class="crop-line"></span>
